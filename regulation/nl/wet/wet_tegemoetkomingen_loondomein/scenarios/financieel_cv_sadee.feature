Feature: Financieel CV, werkgever-perspectief, casus Sadee
  ...
  #
  # is_arbeidsgehandicapte_werknemer en is_herplaatsen_arbeidsgehandicapte
  # staan NIET in de tabel: sinds de verwijzingen worden gevolgd leidt artikel
  # 2.1 die zelf af uit 2.6 en 2.14, via een intra-law source. Ze zijn geen
  # invoer meer maar een uitkomst, en dat is precies het antwoord op de
  # bijvraag uit de vervolgsessie-agenda ("is_arbeidsgehandicapte_werknemer is
  # bij ons een gewone parameter, geen afleiding"). Dat is het nu wel.
  #
  # Bevestigd van de andere kant: J. Hoor1 (SZW) zette deze parameter op
  # 2026-08-20 in de editor van true naar false. Een Wajonger is geen
  # arbeidsgehandicapte werknemer in de zin van artikel 2.1; de categorie is
  # banenafspraak. Sadees LKV gaat daarmee van 507.520 naar 168.064 eurocent.
  #
